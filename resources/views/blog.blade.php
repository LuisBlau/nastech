                            ...
                            <div class="comments" id="comments">
                                ...
                                <div class="comment-list">
                                    ...
                                    <div class="comment" id="comment-1">
                                        <div class="image"><img alt="" src="/media/blog/author.jpg" class="avatar"></div>
                                        <div class="text">
                                        ...
                                        <div class="comment" id="comment-1-1">
                                            <div class="image"><img alt="" src="/media/blog/author2.jpg" class="avatar"></div>
                                            <div class="text">
                                                <h5 class="name">John Doe</h5>
                                                <span class="comment_date">Posted at 15:32h, 06 December</span>
                                                <a class="comment-reply-link" href="#">Reply</a>
                                        ...
                                        <div class="comment" id="comment-1-2">
                                            <div class="image"><img alt="" src="/media/blog/author3.jpg" class="avatar"></div>
                                            <div class="text">
                                                <h5 class="name">John Doe</h5>
                                                <span class="comment_date">Posted at 15:32h, 06 December</span>
                                                <a class="comment-reply-link" href="#">Reply</a>
                                    ...
                                    <div class="comment" id="comment-2">
                                        ...
                                        <div class="text">
                                            ...
                                            <a class="comment-reply-link" href="#">Reply</a>
                                            <div class="text_holder">
                                                <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in
                        ...
                        <div class="tab-content" id="tabs-posts-content">
                            ...
                            <div class="tab-pane fade" id="featured" role="tabpanel" aria-labelledby="featured-tab">
                                <div class="post-thumbnail-list">
                                    ...
                                    <div class="post-thumbnail-entry">
                                        <img alt="" src="/media/blog/thumbnail/8.jpg">
                                        <div class="post-thumbnail-content">
